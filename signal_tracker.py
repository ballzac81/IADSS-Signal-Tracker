...
Per-pair ratios (optional):
  STAKE_RATIO_HYPE_USD=0.33   # override global STAKE_RATIO for HYPE only
  SELL_RATIO_HYPE_USD=0.33    # override global SELL_RATIO for HYPE only
"""
...
def execute_buy(pair: str) -> bool:
    try:
        ...
        telegram(f"IADSS BUY executed\nPair: {pair}\n"
                 f"Stake: ${stake:.2f} ({int(ratio*100)}% of {mode})\n"
